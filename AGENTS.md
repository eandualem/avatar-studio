...
## Active demo animation pass (issue #22)
...
runtime prompt activation notes are in `docs/motion-testing.md`. Finish real-rig,
browser and lifecycle validation, review and merge before calling this delivered.
